...
export const FOOD_COURT = {
  ...
  stalls: [
      ...
      categories: [
        {
          name: "Thalipeeth",
          items: [
            { name: "Dahi Thalipeeth", price: 50, isVeg: true, img: "https://images.unsplash.com/photo-1589302168068-964664d93dc0?auto=format&fit=crop&w=400&q=80" },
        ...
        },
        {
          ...
          items: [
            ...
            { name: "Tandoor Flavor Momos", price: 60, isVeg: true },
    ...
    // ── 5. Narayan (South Indian Special) ────────────────────
    {
      id: "narayan",
      name: "Narayan",
