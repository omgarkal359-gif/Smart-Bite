...
const CAT_ICONS = {
  ...
  'Cold Coffee': <span className="text-lg leading-none">🧋</span>,
  'Mojito': <span className="text-lg leading-none">🍹</span>,
  'Lassi': <span className="text-lg leading-none">🥛</span>,
  'Butter Milk': <span className="text-lg leading-none">🥛</span>,
