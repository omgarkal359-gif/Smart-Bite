        ...
        {isMobileNavOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed top-0 left-0 bottom-0 h-[100dvh] w-[310px] max-w-[85vw] bg-white z-[310] md:hidden shadow-2xl p-5 flex flex-col justify-between border-r border-slate-200/80 font-sans overflow-hidden"
            >
